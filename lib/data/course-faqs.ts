...
export const courseFaqs: Record<string, PageFaq[]> = {
  ...
  "open-water-diver": [
    {
      ...
      answer: "Life happens. If you need to stop partway through, we'll pause the training and you can complete the remaining dives on a return trip, or transfer to a PADI dive centre at your next destination. The PADI system is designed to be completed in stages.",
    },
    {
  ...
  "advanced-open-water": [
    ...
    },
    {
      ...
      answer: "Well suited. Klathipa Deep is our go-to for the mandatory deep dive. The SS British Sergeant wreck works perfectly for wreck adventure diving. And the navigation dive on a site like Coral Garden, where natural reference points are clear, is genuinely useful practice.",
    },
  ],
  "rescue-diver": [
    {
  ...
  "emergency-first-response": [
    ...
    },
    {
      ...
      answer: "No. The skills you learn are general emergency response skills. They apply anywhere: on the street, at home, at a sport event. The diving context is that it's required for Rescue Diver, but the certificate itself is a general first aid qualification.",
    },
  ],
  "deep-diving": [
    {
  ...
  "night-diving": [
    ...
    },
    {
      ...
      answer: "Completely different. Creatures that hide during the day come out at night: crabs, lobsters, octopus, sleeping parrotfish in their mucus cocoons. Predators become more active. The reef looks different too. Torch-lit colours pop in a way that daylight and blue water don't allow.",
    },
  ],
  "nitrox-diving": [
    {
      question: "What's the main advantage of diving with nitrox?",
      answer: "Longer no-decompression limits at depth, and faster surface recovery between dives. On a two-dive day in Trincomalee, nitrox adds meaningful bottom time to your second dive. The trade-off is a lower maximum depth limit. Nitrox 32 divers are limited to 34 m.",
    },
    {
      question: "How long does the nitrox course take?",
      answer: "It's a short specialty, usually half a day of knowledge development and a check-out dive. No extensive pool training. If you're already a certified Open Water diver, you'll be nitrox-certified by the end of your first day.",
    },
  ],
