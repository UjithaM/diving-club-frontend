...
export const faqs: Faq[] = [
  ...
  {
    category: "diving-basics",
    question: "How old do you need to be to scuba dive?",
    answer:
  ...
  {
    category: "diving-basics",
    question: "What's the difference between the Scuba Diver and Open Water Diver courses?",
    answer:
      "Scuba Diver is the shorter route: two days, certifies you to dive with a professional to 12 m. Open Water takes four days and gives you full independence: dive with any certified buddy, anywhere in the world, to 18 m. If you've got four days in Trincomalee, Open Water is almost always the better call. Scuba Diver is really only worth it if your time is genuinely tight.",
  },

  // Diving in Trincomalee
  {
    category: "trincomalee",
    question: "When is the best time to dive in Trincomalee?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Quite a lot, honestly. Hawksbill turtles are almost a given on most dive sites. Moray eels, lionfish, reef sharks, barracuda, parrotfish, triggerfish, stingrays: all common. Blue whales pass through on migration (best in April to early May, viewed from the surface, not underwater). Dolphins, spinner and bottlenose, are regular around the bay. On deeper sites like Klathipa, there's a chance of napoleon wrasse and occasional hammerheads. We're not in the habit of over-promising on wildlife, but Trincomalee consistently delivers.",
  },
  {
    category: "trincomalee",
    question: "Is Trincomalee good for wreck diving?",
    answer:
  ...
  {
    category: "trincomalee",
    question: "How's the water visibility?",
    answer:
  ...
  // Booking & Travel
  {
    ...
    question: "How do I book a course or dive?",
    answer:
  ...
  {
    category: "booking-travel",
    question: "How do I get to Trincomalee?",
    answer:
  ...
  {
    category: "booking-travel",
    question: "Can non-divers or family members come on the boat?",
    answer:
  ...
  {
    category: "safety-eco",
    question: "What if I feel nervous or anxious underwater?",
    answer:
  ...
  {
    category: "safety-eco",
    question: "Do you follow eco-friendly diving practices?",
    answer:
  ...
  {
    category: "safety-eco",
    question: "What medical conditions affect diving?",
    answer:
