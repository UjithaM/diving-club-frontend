      ...
      <section className="bg-charcoal-sea py-16 lg:py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-warm-white/60 text-lg leading-relaxed">
            A bay full of WWII history. Coral reefs with Hindu deity statues at depth. Blue whales passing through in season. Trincomalee is one of Asia&apos;s genuinely exceptional dive destinations — and most people still haven&apos;t heard of it.
          </p>
        </div>
      </section>
